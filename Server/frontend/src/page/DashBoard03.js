...
export default function DashBoard03() {
  ...
  return (
    <div>
      ...
      <div class="row">
        <div class="col-12 midleboxcolor"></div>
        ...
        <div class="col-12 bg_color_blue">
          <div class="row mt-5">
            <div class="col-10 offset-1 quixbox">
              <div class="row">
                <div class="col-4 fit" style={{ background: "white" }}>
                    ...
                    <div class="col-6 mt-3">
                      <div class="row">
                        ...
                        <div class="col-4 numberbo">
                          <h4 style={{ color: "white" }} class="mt-1 ms-1">
                            70
                          </h4>
                        </div>
                      </div>
                ...
                <div class="col-8">
                  <div class="row mt-5 ms-3">
                    ...
                    <h6>
                      We found a few things that will improve your resume.
                    </h6>
                  </div>
                  <div class="row ms-5 mt-5">
                    ...
                    <div class="col-6">
                      ...
                      <div class="row d-flex justify-content-center">
                        <div
                          class="col-4 boxbtrow mt-2"
                          style={{ color: " rgba(89, 154, 253, 0.52)" }}
                        ></div>
                        <div class="col-8">
                          <h5>Word choice</h5>
                        </div>
                  ...
                  <div class="row d-flex justify-content-center">
                    <div class="endBoxBTN"  onClick={fix}>
          ...
          <div class="row mt-5 ms-5">
            <div class="col-6 mt-5 mb-5">
              <h3 class="ms-5" style={{ color: "white" }}>
                My Resumes
              </h3>
            </div>
            <div class="col-6">
              <div class="row">
                <div class="underBTN"  onClick={new_creat}>>
